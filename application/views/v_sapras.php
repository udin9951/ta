            ...
            <div class="row d-flex Gallery" style="margin-bottom: 200px;">
                ...
                <div class="col-6 col-md-4">
                    <div class="services__item card p2">
                        <img style="object-fit: revert !important;" class="img-thumbnail w-100" src="<?= file_exists(FCPATH.'/sampul/'. $value->foto_sapras) ? base_url('sampul/'. $value->foto_sapras) : "https://via.placeholder.com/300x300.png/001177?text=$value->nama_sapras"; ?>">
