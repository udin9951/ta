    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="item form-group">
                ...
                <input type="text" name = "jdl_berita" required="required" placeholder="Judul Artikel" class="form-control ">
                </div>
            </div>

            <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">Foto Artikel</label>
                <div class="col-md-6 col-sm-6 ">
