    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="item form-group">
                ...
                <input type="text" value ="<?= $penceramah->nama_penceramah?>" name = "nama_penceramah" required="required" placeholder="Nama Penceramah" class="form-control ">
                </div>
            </div>
