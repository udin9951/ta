        ...
        <div class="x_panel">
            ...
            <div class="x_content">
              ...
              if (isset($error_upload)) {
               ...
               echo form_open_multipart('kas_keluar/edit/'.$kas->id_kas); ?>

            <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">Tanggal Kas<span class="required"></span>
                </label>
                <div class="col-md-6 col-sm-6 ">
                <input type="date" name = "tgl_kas" value="<?= $kas->tgl_kas?>" required="required" placeholder="Tanggal Kas" class="form-control ">
                </div>
            </div>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" name = "uraian_kas" value="<?= $kas->uraian_kas?>" required="required" placeholder="Uraian Kas" class="form-control ">
                </div>
            </div>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input class="form-control" type="text" name="kas_keluar" value="<?= $kas->kas_keluar?>" placeholder="Jumlah Pengeluaran" >
                </div>
            </div>
