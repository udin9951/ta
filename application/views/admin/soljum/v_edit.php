...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Edit Data Jadwal Khotib Salat Jumat</h2>
            ...
            <div class="x_content">
                <br />
                <?php
                echo form_open_multipart('soljum/edit/' . $soljum->id_soljum); ?>

                <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align">Tanggal<span class="required"></span>
                    </label>
                    <div class="col-md-6 col-sm-6 ">
                        <input type="date" value="<?= $soljum->tgl_soljum ?>" name="tgl_soljum" required="required" placeholder="Tanggal" class="form-control ">
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <select required name="id_imam" class="form-control">
                            ...
                            foreach ($imam as $key => $value) { ?>
                                <option <?php if ($soljum->id_imam  == $value->id_imam) echo 'selected'; ?> value="<?= $value->id_imam ?>"><?= $value->nama_imam ?></option>
                            <?php }
                            ?>
                        </select>
                    </div>
